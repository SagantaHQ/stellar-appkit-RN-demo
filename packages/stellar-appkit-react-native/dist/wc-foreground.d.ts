 ...
 */
export declare function useWalletConnectForegroundRefresh(client: StellarAppKit): void;
/**
 ...
 */
export declare function attachWalletConnectForegroundRefresh(client: StellarAppKit): () => void;
//# sourceMappingURL=wc-foreground.d.ts.map