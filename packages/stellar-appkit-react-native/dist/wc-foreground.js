...
function refreshWalletConnect(client) {
    try {
 ...
 */
export function useWalletConnectForegroundRefresh(client) {
 ...
 */
export function attachWalletConnectForegroundRefresh(client) {
    const subscription = AppState.addEventListener('change', (state) => {
        if (state === 'active')
            refreshWalletConnect(client);
    });
...
//# sourceMappingURL=wc-foreground.js.map