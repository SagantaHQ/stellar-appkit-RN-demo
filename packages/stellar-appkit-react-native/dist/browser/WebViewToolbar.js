 ...
 */
export function formatUrlChip(url, max = 26) {
...
export function WebViewToolbar({ url, onCancel, onReload, dark = true, cancelLabel }) {
    ...
    return (_jsxs(View, { style: [styles.row, { backgroundColor: bg }], children: [_jsx(Pressable, { onPress: onCancel, hitSlop: 12, accessibilityRole: "button", accessibilityLabel: cancelLabel ?? t('action.cancel'), children: _jsx(Text, { style: { color: fg, fontSize: 15, fontWeight: '600' }, children: cancelLabel ?? t('action.cancel') }) }), _jsxs(Pressable, { style: [styles.chip, { backgroundColor: chipBg }], onPress: copyUrl, hitSlop: 6, accessibilityRole: "button", accessibilityLabel: t('browser.copy_link'), children: [_jsx(Text, { style: [styles.chipText, { color: copied ? muted : fg }], numberOfLines: 1, ellipsizeMode: "middle", children: copied ? t('wc.copied') : formatUrlChip(url) }), copied ? (_jsx(CheckIcon, { color: muted, size: 12 })) : (_jsx(CopyIcon, { color: muted, size: 12 }))] }), _jsx(Pressable, { onPress: onReload, hitSlop: 10, accessibilityRole: "button", accessibilityLabel: t('browser.reload'), style: styles.iconButton, children: _jsx(RetryIcon, { color: fg, size: 16 }) }), _jsx(Pressable, { onPress: openExternally, hitSlop: 10, accessibilityRole: "button", accessibilityLabel: t('browser.open_in_browser'), style: styles.iconButton, children: _jsx(ExternalLinkIcon, { color: fg, size: 16 }) })] }));
}
...
//# sourceMappingURL=WebViewToolbar.js.map