...
export function installPolyfills() {
    ...
    if (typeof g.Buffer === 'undefined') {
        try {
            ...
            notes.push(`Buffer is missing and the "buffer" package could not be loaded (${String(err)}). ` +
    ...
    if (typeof cryptoObj.getRandomValues !== 'function') {
        try {
            ...
            notes.push(`crypto.getRandomValues is missing and "react-native-get-random-values" could not be loaded (${String(err)}). ` +
    ...
    try {
        ...
        notes.push('@walletconnect/react-native-compat is not installed — required for the ' +
