 ...
 */
import { type WalletConnector, type ConnectStorage } from '@saganta/stellar-appkit';
import { type AlbedoWebViewBridge } from './albedo-webview.js';
import { type XBullWebViewBridge } from './xbull-webview.js';
 ...
 */
export declare function defaultReactNativeConnectors(opts: ReactNativeConnectorsOptions): WalletConnector[];
...
export type { XBullWebViewBridge, XBullWalletHandle, XBullWalletMessage, XBullWebViewConnectorOptions, } from './xbull-webview.js';
