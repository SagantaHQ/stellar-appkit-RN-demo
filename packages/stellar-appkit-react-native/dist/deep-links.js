...
export function listFeaturedMobileWallets() {
...
export function listAdditionalMobileWallets() {
    return listMobileWallets().filter((wallet) => !wallet.featured);
}
